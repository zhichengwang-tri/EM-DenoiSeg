                ...
                for k, batch in tqdm(enumerate(dataloader, 0)):
                    ...
                    with torch.no_grad():
                        ...
                        if fushion_mode == 'noisy':
                            ...
                            pred_dn = model_denoise(torch.concat((inputs,coarse_denoise),dim=1),pred_affs)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='unified_a_refine', help='path to config file')
