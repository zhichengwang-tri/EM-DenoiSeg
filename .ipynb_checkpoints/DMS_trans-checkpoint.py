...
def build_2model(cfg, writer):
    ...
    if cfg['MODEL']['MODEL_denoise']['model_type'] == 'unet2d':
                    ...
                    with torch.no_grad():
                        for i in range(4):
                            for j in range(4):
                                ...
                                pred_affs_ = model_seg(denoised_)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='dms_c_trans_dncnn', help='path to config file')
