...
def build_2model(cfg, writer):
    ...
    model_seg = UNet2D(in_channel=1, out_channel=10, if_sigmoid=True, type = 'seg',fa=False).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='test_c_n', help='path to config file')
