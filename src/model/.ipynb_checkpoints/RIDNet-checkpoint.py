...
'''
https://github.com/eremo2002/Pytorch-RIDNet/tree/main
'''
...
class RIDNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, num_features=128):
        ...
        self.last_conv = nn.Conv2d(num_features, out_channels, kernel_size=3, stride=1, padding=1, dilation=1)
