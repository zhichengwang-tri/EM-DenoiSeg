...
class DiscriminativeLoss(nn.Module):
    def __init__(self, delta_v=0.5, delta_d=1.5, alpha=1, beta=1, gama=0.001):
    ...
    def forward(self, embedding, seg_gt):
        return discriminative_loss(embedding, seg_gt, self.delta_v, self.delta_d, self.alpha, self.beta, self.gama)